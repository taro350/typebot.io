...
type Props = {
  ...
  onPointerDown: (e: React.PointerEvent, type: DraggableBlockType) => void
}
...
const BlockCardLayout = ({ type, onPointerDown, tooltip, children }: Props) => {
