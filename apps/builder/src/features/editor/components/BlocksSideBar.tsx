...
export const BlocksSideBar = () => {
  ...
  const updateDraggedBlockPosition = (event: MouseEvent) => {
  ...
  useEventListener('pointermove', updateDraggedBlockPosition)
  ...
  useEventListener('pointerup', resetDraggedBlockType)
        ...
        {draggedBlockType && (
          <Portal>
            <BlockCardOverlay
              ...
              onMouseUp={resetDraggedBlockType}
              pos="fixed"
              top="0"
              left="0"
              style={{
