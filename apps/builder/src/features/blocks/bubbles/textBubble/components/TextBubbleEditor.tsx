...
type TextBubbleEditorContentProps = {
  ...
  onChange: (newContent: TextBubbleContent) => void
}
...
const TextBubbleEditorContent = ({
  ...
  const closeEditor = useCallback(() => {
    const convertValueToBlockContent = (
      value: TElement[]
    ): TextBubbleContent => {
    ...
    onChange(convertValueToBlockContent(textEditorValue))
  }, [editor, onChange, textEditorValue])
